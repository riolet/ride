...
const QMetaObject QsciLexerYAML::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerYAML.data,
      qt_meta_data_QsciLexerYAML,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QsciLexerYAML::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerYAML.stringdata0))
