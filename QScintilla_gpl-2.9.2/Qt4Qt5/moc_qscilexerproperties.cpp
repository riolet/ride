...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QsciLexerProperties_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QsciLexerProperties_t qt_meta_stringdata_QsciLexerProperties = {
    {
QT_MOC_LITERAL(0, 0, 19), // "QsciLexerProperties"
QT_MOC_LITERAL(1, 20, 14), // "setFoldCompact"
QT_MOC_LITERAL(2, 35, 0), // ""
QT_MOC_LITERAL(3, 36, 4) // "fold"
...
const QMetaObject QsciLexerProperties::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerProperties.data,
      qt_meta_data_QsciLexerProperties,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QsciLexerProperties::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerProperties.stringdata0))
