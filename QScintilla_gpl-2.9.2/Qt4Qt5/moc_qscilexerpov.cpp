...
const QMetaObject QsciLexerPOV::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerPOV.data,
      qt_meta_data_QsciLexerPOV,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QsciLexerPOV::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerPOV.stringdata0))
