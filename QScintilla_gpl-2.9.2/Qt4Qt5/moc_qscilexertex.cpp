...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_QsciLexerTeX_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QsciLexerTeX_t qt_meta_stringdata_QsciLexerTeX = {
    {
QT_MOC_LITERAL(0, 0, 12) // "QsciLexerTeX"
...
const QMetaObject QsciLexerTeX::staticMetaObject = {
    { &QsciLexer::staticMetaObject, qt_meta_stringdata_QsciLexerTeX.data,
      qt_meta_data_QsciLexerTeX,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QsciLexerTeX::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QsciLexerTeX.stringdata0))
