...
struct qt_meta_stringdata_QScintillaPlugin_t {
    QByteArrayData data[1];
    char stringdata0[17];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_QScintillaPlugin_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_QScintillaPlugin_t qt_meta_stringdata_QScintillaPlugin = {
    {
QT_MOC_LITERAL(0, 0, 16) // "QScintillaPlugin"
...
void QScintillaPlugin::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    Q_UNUSED(_o);
    Q_UNUSED(_id);
    Q_UNUSED(_c);
...
const QMetaObject QScintillaPlugin::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_QScintillaPlugin.data,
      qt_meta_data_QScintillaPlugin,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *QScintillaPlugin::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_QScintillaPlugin.stringdata0))
...
QT_MOC_EXPORT_PLUGIN(QScintillaPlugin, QScintillaPlugin)
